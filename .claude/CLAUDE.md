...
Report all feedback items and their dispositions to the user for visibility.
...
7. **Verify before advancing** — don't proceed on agent summaries alone; read actual output at phase boundaries
