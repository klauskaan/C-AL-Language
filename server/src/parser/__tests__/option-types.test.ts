...
describe('Parser - Option Type Scope Operator (::)', () => {
  ...
  describe('REGRESSION TEST: :: in complex expressions', () => {
    ...
    it.skip('should parse :: in IN expression with array', () => {
      // SKIP: This test requires array literal support [val1, val2] which is not yet implemented
      // The :: operator itself works fine, but the parser doesn't support [...] array literals in expressions
      // TODO: Implement array literal parsing, then re-enable this test
      const code = `OBJECT Codeunit 1 Test {
        CODE {
          PROCEDURE Test();
          BEGIN
